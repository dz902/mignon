  ...
  Vex.Inherit(StaveNote, Vex.Flow.StemmableNote, {
    init: function(note_struct) {
      StaveNote.superclass.init.call(this, note_struct);
			...
			this.__data = note_struct.__data;
    ...
    drawNoteHeads: function(){
      var that = this;
      this.note_heads.forEach(function(note_head, i) {
      	var id = 'vex-note-id-'+this.__data.getIn([i, 'id']);
        that.context.openGroup("notehead", id, {pointerBBox: true});
...
Vex.Flow.Tuplet = (function() {
  ...
  Tuplet.prototype = {
    ...
    beatsOccupiedDeprecationWarning: function(){
    ...
    getNotesOccupied: function() {
      return this.notes_occupied;
    },

    setNotesOccupied: function(notes) {
      this.detach();
